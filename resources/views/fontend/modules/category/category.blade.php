            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h3>Danh Sách {{ $categorydetail->name }} </h3>
                                ...
                                <div class="col-md-4">
                                    <figure class="card card-product-grid card-lg"> <a
                                        ...
                                        <div class="bottom-wrap"> <a onclick="AddCart({{ $item->id }})"
                                                href="javascript:" class="btn btn-primary float-right" data-abc="true">
                                                Giỏ
                                                hàng </a>
