        ...
        <div id="content-wrapper" class="d-flex flex-colum">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Quản lí nhà cung cấp </h1>
                    @include('backend.component.flash-message')
                    <div class="d-add"><a href="{{ route('producer.create') }}"><button type="button"
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/producer/edit/{{ $item->id }}"> <button
                                                        type="button" class="btn-success">
                                                        Sửa</button></a>
                                                <a href="/admin/producer/delete/{{ $item->id }}"><button
                                                        class="btn-success"
