        ...
        <div id="content-wrapper" class="d-flex flex-colum">
            <div id="content">
                ...
                <div class="container-fluid">
                  <form method="POST" enctype="multipart/form-data" id="upload-image" action="/admin/product/store">
                    @method('POST')
                    @csrf
                        ...
                        <h2>Thêm mới sản phẩm</h2>
                         ...
                         <div class="box-body">
                             <div >
                                 ...
                                 <div>
                                  <h6>Mô tả ngắn</h6>
                                  <textarea name="sortDesc" class="form-control" style="width: 100%;"></textarea>
                                 </div>
                             ...
                             <div>
                                 <h6>Giá gốc</h6>
                                 <input type="number" name="price_root">
                                 <h6>Khuyến mãi (%)</h6>
                                 <input type="number" name="sale_of">
                                 <h6>Giá bán </h6>
