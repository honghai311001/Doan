        ...
        <div id="content-wrapper" class="d-flex flex-colum">
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="/admin/discount/update/{{ $items->id }}" method="POST">
                        @method('POST')
                        @csrf
                        <div class="content-header">
                            ...
                            <div class="box-body">
                                <div>
                                    ...
                                    <h6> Số lần nhập </h6>
                                    <input type="text" name="limit_number" value="{{ $items->limit_number }}">
                                    <h6>Số tiền tối thiểu đơn hàng được áp dụng</h6>
                                    <input type="text" name="payment_limit" value="{{ $items->payment_limit }}">

                                </div>
                                <div>
                                    <h6>Ngày giới hạn nhập</h6>
                                    <input type="date" name="expiration_date" value="{{ $items->expiration_date }}">
                                    <h6>Mô tả ngắn</h6>
